...
Menampilkan daftar satuan barang yang telah di buat, digunakan saat membuat master barang.
...
<table class="data-table table table-striped table-bordered table-hover table-checkable order-column">
    ...
    <tbody>
        ...
        <tr class="odd gradeX">
            ...
            <td> {{ $satuan_barang['NAMA_SATUAN_BARANG'] }} </td>
            <td>
                <div class="btn-group">
                  <a href="{{ url($pathLink.'update', \encrypt($satuan_barang['ID_SATUAN_BARANG'])) }}">
