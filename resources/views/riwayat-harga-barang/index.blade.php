...
<ul>
  <li>Halaman ini menampilkan daftar barang beserta harga jualnya. </li>
  <li>Pastikan sebelum mengisi harga barang, anda telah mengisi master barang</li>
...
<table class="data-table table table-striped table-bordered table-hover table-checkable order-column">
    ...
    <tbody>
        ...
        <tr class="odd gradeX">
            ...
            <td> Rp. {{  number_format('7000', 2, ',', '.') }} </td>
            <td> 400 </td>
            <td>
                <div class="btn-group">
                  <a href="{{ url($pathLink.'update', encrypt($barang['ID_BARANG'])) }}">
                    <button class="btn btn-xs btn-danger" type="button"> Set Harga
